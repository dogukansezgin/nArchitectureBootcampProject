...
public interface IBootcampImageService
{
    ...
    Task<BootcampImage> AddAsync(IFormFile file, BootcampImageRequest bootcampImage);
    Task<BootcampImage> UpdateAsync(IFormFile file, UpdateBootcampImageRequest bootcampImage);
